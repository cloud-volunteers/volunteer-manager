function generateInside(name, placeholder){
    ...
    let input = 
    `<input name = \"${name}\" placeholder = \"${placeholder}\" value = \"{{ volunteer.${name} }}\" class = \"m-1 bg-slate-200 border-2 border-solid border-slate-600 shadow-md shadow-slate-300 dark:text-black\" />`
