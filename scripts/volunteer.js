function generateInside(name, placeholder, jinja){
    ...
    let input = 
    `<input name = \"${name}\" placeholder = \"${placeholder}\" value = \"${jinja}\" ${readonly} class = \"m-1 bg-slate-200 border-2 border-solid border-slate-600 shadow-md shadow-slate-300 dark:text-black\" />`
